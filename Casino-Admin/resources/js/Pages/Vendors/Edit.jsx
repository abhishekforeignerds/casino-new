...
export default function Edit({ client, roles, plants, raw_materials }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        role: client.roles.length > 0 ? client.roles[0].name : 'Vendor',
        company_name: client.company_name || '',
        gstin_number: client.gstin_number || '',
        pan_card: client.pan_card || '',
        state_code: client.state_code || '',
        company_address: client.company_address || '',
        plant_id: client.plant_assigned || '',
        raw_materials: client.raw_materials || [], // prefilled raw materials array
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('vendors.update', client.id));
    };

    // Raw materials search and pagination
    ...
    const availableRawMaterials = raw_materials || [];
    ...
    const materialsSource = rawMaterialsSearch ? filteredRawMaterials : availableRawMaterials;
            ...
            <div className="main-content-container sm:ml-52">
                <div className="mx-auto py-6 flex justify-between flex-col md:flex-row gap-2">
                    <p className="flex">
                        ...
                        <Link href={route('vendors.index')}>Vendors Management</Link>
                        <FiChevronRight size={24} color="black" />
                        <span className="text-red">Edit Vendor</span>
                    </p>
                    <Link
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 min-h-[80vh]">
                            <div className="top-search-bar-box flex py-4">
                                <h2 className="font-semibold text-3xl mb-6">Edit Vendor</h2>
                            </div>
