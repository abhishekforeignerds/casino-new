...
class PlantRawMaterialsImport implements ToModel, WithHeadingRow, WithValidation
{
    /**
    ...
    public function model(array $row)
    {
        ...
        $row['status'] = $status;
        $rawMaterial = RawMaterial::where('material_code', $row['item_code'])->first();
        ...
        // Now create the PlantRawMaterial with the associated raw_material_id
        return new PlantRawMaterial([
