            ...
            <div class="container">
                <div class="profile-edit-wrapper">
                    <div class="row gy-5">
                        <div class="col-xl-4">
                            <div
                                class="profile__thumb__edit text-center custom--card">
                                <div class="card--body">
                                    <div class="thumb">
                                        <img
                                    ...
                                    <div class="profile__info">
                                        ...
                                        <label
                                            ...
                                            for="update-photo">Update Profile
                                            Picture</label>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span
                                                        class="input-group-text text--base">+192</span>
                                                    <input id="number"
                                                        type="tel"
                                                        class="form-control form--control style-two "
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea
                                                    ...
                                                    placeholder="I'm a Front-end Web Developer. ...."></textarea>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <button
                                                class="cmn--btn active mt-3">Update
                                                Profile</button>
                                        </div>
                                    </div>
                                </div>
