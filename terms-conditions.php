                ...
                <div class="row gy-5">
                    <div class="col-lg-3">
                        <ul class="privacy-policy-sidebar-menu">
                            <li>
                                <a href="#overview"
                                    class="active nav-link">Overview</a>
                            </li>
                            <li>
                                <a href="#data-collection" class="nav-link">Data
                                    Collection & Use</a>
                            </li>
                            <li>
                                <a href="#cookies" class="nav-link">Cookies
                                    Data</a>
                            </li>
                            <li>
                                <a href="#data-security" class="nav-link">Data
                                    Security</a>
                            </li>
                            <li>
                                <a href="#overview2" class="nav-link">Customer
                                    Information</a>
                            </li>
                            <li>
                                <a href="#overview3" class="nav-link">Data
                                    Collection & Use</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="privacy-policy-content">
                            <div class="content-item">
                                ...
                                <p>
                                    ...
                                    adipisicing elit. Assumenda officia vel
                                    omnis, odit quidem, expedita nam deserunt
                                    molestiae accusamus voluptas aut. Sapiente
                                    voluptatem nulla unde quia harum illum ipsum
                                    dolore! Lorem ipsum dolor sit amet
                                    consectetur adipisicing elit. In dolorem
                                    illum molestiae corrupti, maxime sint velit
                                    quibusdam officiis ipsam a minima quos
                                    voluptates possimus eaque, vitae, veniam
                                    consequuntur! Dolorem, architecto.
                                </p>
                            </div>
                            <div class="content-item">
                                <h4 class="title" id="data-collection">Data
                                    Collection & Use</h4>
                                <p>
                                    Lorem ipsum dolor sit, amet consectetur
                                    adipisicing elit. Assumenda officia vel
                                ...
                                <ul class="info-list">
                                    <li>There are many variations of passages of
                                        Lorem
                                        available, but the majority</li>
                                    <li>Finibus onorum et alorum" by icero
                                        classical lite
                            ...
                            <div class="content-item">
                                <h4 class="title" id="data-security">Data
                                    Collection & Use</h4>
                                <p>
                                    Lorem ipsum dolor sit, amet consectetur
                                    adipisicing elit. Assumenda officia vel
                            ...
                            <div class="content-item">
                                <h4 class="title" id="overview2">Data
                                    Cookies</h4>
                                <p>
                                    deserunt molestiae accusamus voluptas aut.
                                    Sapiente voluptatem nulla unde quia harum
                                    illum ipsum dolore! Lorem ipsum dolor sit
                                    amet consectetur adipisicing elit. In
                                    dolorem illum molestiae corrupti, maxime
                                    sint velit quibusdam officiis ipsam a minima
                                    quos voluptates possimus eaque, vitae,
                                    veniam consequuntur! Dolorem, architecto.
                                    Lorem ipsum dolor sit, amet consectetur
                                    adipisicing elit. Assumenda officia vel
                                    omnis, odit quidem, expedita nam deserunt
                                    molestiae accusamus voluptas aut. Sapiente
                            ...
                            <div class="content-item">
                                <h4 class="title" id="overview3">Data
                                    Storage</h4>
                                <p>
                                    Pconsectetur adipisicing elit. Assumenda
                                    officia vel omnis, odit quidem, expedita nam
                                    deserunt molestiae accusamus voluptas aut.
                                    Sapiente voluptatem nulla unde quia harum
                                    illum ipsum dolore! Lorem ipsum dolor sit
                                    amet consectetur adipisicing elit. In
