...
export default function Edit({ role, permissions }) {
    ...
    // Formats group names (e.g., replace hyphens with spaces, title-case each word)
    ...
    const handleGroupToggle = (groupPermissions) => {
        ...
        if (allSelected) {
            ...
            setData(
                'permissions',
                data.permissions.filter(p => !groupPermissions.some(permission => permission.name === p))
            );
        } else {
            // Add any permission in the group that is not already selected.
                ...
                <div className="mx-auto py-6">
                    <div>
                        <p className="flex items-center space-x-2">
                            ...
                            <FiChevronRight size={24} color="black" />
                            <span className="text-red">Edit Role</span>
                        </p>
                        <Link
                    ...
                    <div className="bg-white shadow-sm sm:rounded-lg p-6 text-gray-900">
                        <form onSubmit={handleSubmit} className="styled-form">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                {/* Grouped Permissions with group toggle */}
                                        ...
                                        <div key={groupKey} className="mb-6">
                                            <div className="flex items-center justify-between mb-2">
                                                <h3 className="font-bold text-gray-700 flex items-center">
                                                    ...
                                                    <span className="mx-2 text-sm text-gray-600">Permissions:</span>
                                                ...
                                                {groupPermissions.map((permission) => (
                                                    <div key={permission.id} className="flex items-center">
                                                        <input
                                                            ...
                                                            className="mr-2"
                                                        />
                                                        {/* Optionally show only the action (first word) */}
