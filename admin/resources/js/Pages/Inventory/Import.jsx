            ...
            <div className="main-content-container sm:ml-52">
                <div className="mx-auto pt-6 flex justify-between flex-col md:flex-row gap-2">
                    <p className='flex flex-wrap'>
                        ...
                        <Link href={route('inventory.index')}>Inventory Management</Link>
                        <FiChevronRight size={24} color="black" />
                        <span className='text-red'>Import FG &  RM Connection</span>
                    </p>

                    <Link href={route('inventory.index')} className="border border-red py-1 px-14 text-red rounded max-w-max">
                        Back
                    </Link>
                </div>
                                ...
                                >
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6 gap-3 px-6">
                                        ...
                                        <p className="text-md font-bold text-center text-black mb-6">
                                            File Column Should be fg_code, fg_item_description, rm_code, rm_item_description, fg_gross_wt , fg_net_wt, scrap_net_wt
